...
class SpaceAgeTest extends AnyFunSuite with Matchers {
  ...
  test("age on Earth") {
    ...
    SpaceAgeDynamic.onEarth(1000000000) should be(31.69 +- 0.01)
  ...
  test("age on Mercury") {
    ...
    SpaceAgeDynamic.onMercury(2134835688) should be(280.88 +- 0.01)
  }
  ...
  test("age on Venus") {
    ...
    SpaceAgeDynamic.onVenus(189839836) should be(9.78 +- 0.01)
  }
  ...
  test("age on Mars") {
    ...
    SpaceAgeDynamic.onMars(2.329871239e9) should be(39.25 +- 0.01)
  }
  ...
  test("age on Jupiter") {
    ...
    SpaceAgeDynamic.onJupiter(901876382) should be(2.41 +- 0.01)
  }
  ...
  test("age on Saturn") {
    ...
    SpaceAgeDynamic.onSaturn(3.0e9) should be(3.23 +- 0.01)
  }
  ...
  test("age on Uranus") {
    ...
    SpaceAgeDynamic.onUranus(3.210123456e9) should be(1.21 +- 0.01)
  }
  ...
  test("age on Neptune") {
    ...
    SpaceAgeDynamic.onNeptune(8.210123456e9) should be(1.58 +- 0.01)
  }
}
